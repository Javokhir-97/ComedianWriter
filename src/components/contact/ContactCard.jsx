...
import Img1 from '../../assets/photo_6251322077990731645_x.jpg'
  ...
  return (
    ...
    >
      <CardContent sx={{ alignItems: 'center', textAlign: 'center' }}>
        <Avatar src={Img1} sx={{ '--Avatar-size': '4rem' }} />
        <Chip
          size="sm"
          variant="soft"
          color="primary"
      ...
      <CardOverflow sx={{ bgcolor: 'GrayText' }}>
        <CardActions buttonFlex="1">
          <ButtonGroup variant="outlined" sx={{ bgcolor: 'GrayText' }}>
